...
to setup-patches
  ...
  ;  paint-stripes  0  140  -1  0 max-pxcor max-pycor lane-divider-color 5
  ;
  ;  paint-stripes -80  0  0  1 max-pxcor max-pycor lane-divider-color 5
  ;  paint-stripes -80  0  0 -1 max-pxcor min-pycor lane-divider-color 5
...
to setup-traffic-lights
  foreach [0 180]         [ ?1 -> set-car-light ?1 green ]  ;; "NS"
  foreach [90 270]        [ ?1 -> set-car-light ?1 red ]  ;; "EW"

  foreach [0 180]         [ ?1 -> set-car-light1 ?1 green ]  ;; "NS"
  foreach [90 270]        [ ?1 -> set-car-light1 ?1 red ]  ;; "EW"

  foreach [0 180]         [ ?1 -> set-car-light2 ?1 green ]  ;; "NS"
  foreach [90 270]        [ ?1 -> set-car-light2 ?1 red ]  ;; "EW"

  foreach [0 180]         [ ?1 -> set-car-light3 ?1 green ]  ;; "NS"
  foreach [90 270]        [ ?1 -> set-car-light3 ?1 red ]  ;; "EW"
