...
cars-own [speed acceleration direction source destination start-time Decision07 Decision12 Decision34 Decision56]

patches-own
[
  intersection? intersection-1? intersection-2? intersection-3? sidewalk? crosswalk? track?
  sensor0? sensor1? sensor2? sensor3? from change-marker
]
...
[
  ...
  ; source = 0 or 7, destination = 3 or 4
  ; pheromone
  P07-01
  P07-32
  ; update pheromone
  ...
  ; source = 1 or 2, destination = 5 or 6
  ; pheromone
  P12-10
  P12-23
  ; update pheromone
  ...
  ; source = 3 or 4, destination = 7 or 0
  ; pheromone
  P34-10
  P34-23
  ; update pheromone
  ...
  ; source = 5 or 6, destination = 1 or 2
  ; pheromone
  P56-01
  P56-32
  ; update pheromone
...
to setup-traffic-lights
  ...
  foreach [0 90 180 270] [ ?1 -> set-car-light1 ?1 3 ]
  foreach [0 90 180 270] [ ?1 -> set-car-light2 ?1 3 ]
  foreach [0 90 180 270] [ ?1 -> set-car-light3 ?1 3 ]
end
...
;        ]
        ...
        [
          ...
          if (destination = 3 or destination = 4 ) and Decision07 = "01"
          [
            ; turn left
            if ycor >= 5 [set heading 270
              set shape "car-inverted"]
          ] ; else: go forward to turn left at 32
        ]
        ...
        [
          ...
          if (destination = 5 or destination = 6) and Decision12 = "10"
          [
            ; turn left
        ...
        [
          ...
          if destination = 0 and heading = 90
          [
             if xcor >= -5 [set heading 180]
            ; turn right
          ]
        ...
        [
          ...
          if destination = 7 and heading = 180
          [
            ; turn left
            if ycor <= -5 [set heading 90]
          ]
        ...
        [
          ...
          if (destination = 1 or destination = 2) and heading = 180
          [
            ; turn right
            if ycor <= 5 [set heading 270
              set shape "car-inverted"]
        ...
        [
          ...
          if (destination = 3 or destination = 4) and Decision07 = "32"
          [
            ; turn right
            if xcor <= 5 [set heading 0
              set shape "car"]
...
;        ]
        ...
        [
          ...
          if destination = 3 or destination = 4
          [
            if xcor >= -145 [set heading 0]
            ; turn left
          ]
          if (destination = 5 or destination = 6) and Decision12 = "23"
          [
            if xcor >= -145 [set heading 0]
            ; turn left
          ]
        ...
        [
          ...
          ; Decision34 = "10"
          if (destination = 0 or destination = 7) and Decision34 = "10"
          [
            if ycor <= -5 [set heading 90]
            ; turn left
          ]
...
;        ]
        ...
        [
          ...
          if (destination = 0 or destination = 7) and Decision34 = "23"
          [
            ; turn left
            if ycor <= 135 [set heading 90]
          ]
        ...
        [
          ...
          ; Decision56 = "23"
          if (destination = 1 or destination = 2) and Decision56 = "23"
          [
            ; turn left
            if xcor <= -155 [set heading 180
              set shape "car"]
...
;        ]
        ...
        [
          ...
          ; Decision34 = "23"
          if (destination = 7 or destination = 0) and Decision34 = "23"
          [
            if xcor >= -5 [set heading 180]
            ; turn right
          ]
        ...
        [
          ...
          if (destination = 1 or destination = 2) and Decision56 = "32"
          [
            ; turn right
            if ycor <= 145 [set heading 270
              set shape "car-inverted"]
        ...
        [
          ...
          if (destination = 1 or destination = 2) and Decision56 = "01"
          [
            ; turn left
            if xcor <= -5 [set heading 180
              set shape "car"]
...
;      ]
      ...
      if (source = 0 or source = 7) and (destination = 3 or destination = 4)
      [
        ifelse Decision07 = "01"
        [
          set P07-P-01 ((1 - evaporation-rate) * P07-01)
          set P07-U-01 (P07-P-01 + evaporation-rate * (1 / wait-time))
          set P07-01 P07-U-01
        ]
        [
          if Decision07 = "32"
          [
            set P07-P-32 ((1 - evaporation-rate) * P07-32)
            set P07-U-32 (P07-P-32 + evaporation-rate * (1 / wait-time))
            set P07-32 P07-U-32
          ]
        ]
      ]

      if (source = 1 or source = 2) and (destination = 5 or destination = 6)
      [
        ifelse Decision12 = "10"
        [
          set P12-P-10 ((1 - evaporation-rate) * P12-10)
          set P12-U-10 (P12-P-10 + evaporation-rate * (1 / wait-time))
          set P12-10 P12-U-10
        ]
        [
          if Decision12 = "23"
          [
            set P12-P-23 ((1 - evaporation-rate) * P12-23)
            set P12-U-23 (P12-P-23 + evaporation-rate * (1 / wait-time))
            set P12-23 P12-U-23
          ]
        ]
      ]

      if (source = 3 or source = 4) and (destination = 7 or destination = 0)
      [
        ifelse Decision34 = "10"
        [
          set P34-P-10 ((1 - evaporation-rate) * P34-10)
          set P34-U-10 (P34-P-10 + evaporation-rate * (1 / wait-time))
          set P34-10 P34-U-10
        ]
        [
          if Decision34 = "23"
          [
            set P34-P-23 ((1 - evaporation-rate) * P34-23)
            set P34-U-23 (P34-P-23 + evaporation-rate * (1 / wait-time))
            set P34-23 P34-U-23
          ]
        ]
      ]

      if (source = 5 or source = 6) and (destination = 1 or destination = 2)
      [
        ifelse Decision56 = "01"
        [
          set P56-P-01 ((1 - evaporation-rate) * P56-01)
          set P56-U-01 (P56-P-01 + evaporation-rate * (1 / wait-time))
          set P56-01 P56-U-01
        ]
        [
          if Decision56 = "32"
          [
            set P56-P-32 ((1 - evaporation-rate) * P56-32)
            set P56-U-32 (P56-P-32 + evaporation-rate * (1 / wait-time))
            set P56-32 P56-U-32
          ]
        ]
      ]
...
to init-car [dir]
  ...
  if dir = 0 and xcor = 5 [set source 0]
  if dir = 0 and xcor = -145 [set source 1]
  if dir = 90 and ycor = -5 [set source 2]
  if dir = 90 and ycor = 135 [set source 3]
  if dir = 180 and xcor = -155 [set source 4]
  if dir = 180 and xcor = -5 [set source 5]
  if dir = 270 and ycor = 145 [set source 6]
  if dir = 270 and ycor = 5 [set source 7]
  ...
  if destination = 0 [set color 17]
  if destination = 1 [set color 27]
  if destination = 2 [set color 37]
  if destination = 3 [set color 47]
  if destination = 4 [set color 57]
  if destination = 5 [set color 67]
  if destination = 6 [set color 77]
  if destination = 7 [set color 87]

  if (source = 0 or source = 7) and (destination = 3 or destination = 4)
  [
    set Pro07-01 (P07-U-01 / (P07-U-01 + P07-U-32))
    set Pro07-32 (P07-U-32 / (P07-U-01 + P07-U-32))

    let r1 (random-float 1)
    let r2 (random-float 1)

    ifelse (r1 <= Pro07-01 and r2 <= Pro07-32)
    [
      ifelse r1 > r2
      [
        set Decision07 "01"
  ...
  if (source = 1 or source = 2) and (destination = 5 or destination = 6)
  [
    set Pro12-10 (P12-U-10 / (P12-U-10 + P12-U-23))
    set Pro12-23 (P12-U-23 / (P12-U-10 + P12-U-23))

    let r1 (random-float 1)
    let r2 (random-float 1)

    ifelse (r1 <= Pro12-10 and r2 <= Pro12-23)
    [
      ifelse r1 > r2
      [
        set Decision12 "10"
  ...
  if (source = 3 or source = 4) and (destination = 7 or destination = 0)
  [
    set Pro34-10 (P34-U-10 / (P34-U-10 + P34-U-23))
    set Pro34-23 (P34-U-23 / (P34-U-10 + P34-U-23))

    let r1 (random-float 1)
    let r2 (random-float 1)

    ifelse (r1 <= Pro34-10 and r2 <= Pro34-23)
    [
      ifelse r1 > r2
      [
        set Decision34 "10"
  ...
  if (source = 5 or source = 6) and (destination = 1 or destination = 2)
  [
    set Pro56-01 (P56-U-01 / (P56-U-01 + P56-U-32))
    set Pro56-32 (P56-U-32 / (P56-U-01 + P56-U-32))

    let r1 (random-float 1)
    let r2 (random-float 1)

    ifelse (r1 <= Pro56-01 and r2 <= Pro56-32)
    [
      ifelse r1 > r2
      [
        set Decision56 "01"
